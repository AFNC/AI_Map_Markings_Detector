# AI Map Markings Detector
This project utilizes Deep Learning and Computer Vision to detect the marked regions printed on urban map images, followed by segmentation of the detected regions.
